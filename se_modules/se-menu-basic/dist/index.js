...
function blockTypeItem(nodeType, options, resetNodeType) {
  ...
  var passedOptions = {
      ...
      //NEW:
        ...
        if (!command(state)) {
          ...
          if (resetNodeType) {
            ...
            var command_reset = prosemirrorCommands.setBlockType(resetNodeType, options.attrs);
    ...
    select: prosemirrorCommands.setBlockType(nodeType,options), //if this is present blocktype will be removed if not applicable
